...
%prep
gem unpack %{SOURCE0}
%setup -q -D -T -n detroit-standard-0.4.0
gem spec %{SOURCE0} -l --ruby > rubygem-detroit-standard.gemspec

%build
gem build rubygem-detroit-standard.gemspec
